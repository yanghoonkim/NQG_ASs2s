...
PARAMS=h200_setting7_batch32
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS

PARAMS=h200_setting7_batch64
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS

PARAMS=h200_setting7_batch128
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS

PARAMS=h200_setting7_batch256
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS

PARAMS=h350_setting7_batch32
MODEL_DIR=./store_model/h512_memory_setting5_batch128_
python main.py --model_dir=$MODEL_DIR --params=$PARAMS


PARAMS=h350_setting7_batch64
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS 

PARAMS=h350_setting7_batch128
MODEL_DIR=./store_model/$PARAMS
python main.py --mode='pred ' --model_dir=$MODEL_DIR --params=$PARAMS

PARAMS=h350_setting7_batch256
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS

PARAMS=h512_setting7_batch32
MODEL_DIR=./store_model/$PARAMS
python main.py --mode='pred' --model_dir=$MODEL_DIR --params=$PARAMS


PARAMS=h512_setting7_batch64
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS


PARAMS=h512_setting7_batch128
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS 

PARAMS=h512_setting7_batch256
MODEL_DIR=./store_model/h512_memory_setting5_batch128
python main.py --model_dir=$MODEL_DIR --params=$PARAMS

PARAMS=h800_setting7_batch32
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS

PARAMS=h800_setting7_batch64
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS


PARAMS=h800_setting7_batch128
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS


PARAMS=h800_setting7_batch256
MODEL_DIR=./store_model/$PARAMS
python main.py --model_dir=$MODEL_DIR --params=$PARAMS
